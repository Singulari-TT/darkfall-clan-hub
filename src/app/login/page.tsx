        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white">
            <div className="p-10 bg-gray-800 rounded-xl shadow-2xl space-y-6 text-center border border-gray-700 max-w-md w-full">
                ...
                <button
                    ...
                    className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(79,70,229,0.5)] flex items-center justify-center gap-3"
                >
